...
auth_classes = []
if is_app_installed('rest_framework_simplejwt'):
    auth_classes.append('rest_framework_simplejwt.authentication.JWTAuthentication')
...
# Email Delivery Settings (SMTP / SendGrid / Amazon SES Production Ready)
...
DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default='EstateIQ <noreply@estateiq.com>')
