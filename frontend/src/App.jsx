              ...
              <Routes>
                ...
                <Route path="/terms" element={
                  <div className="max-w-max-width mx-auto px-4 py-12 space-y-4">
                    ...
                    <p className="text-xs text-slate-grey font-body-md">
                      /* DPDP Act 2023 Compliant Terms of Service. Note: Legal counsel should review before production launch. */
                    </p>
                ...
                <Route path="/privacy" element={
                  <div className="max-w-max-width mx-auto px-4 py-12 space-y-4">
                    ...
                    <p className="text-xs text-slate-grey font-body-md">
                      /* DPDP Act 2023 Privacy Policy. Note: Legal counsel should review before production launch. */
                    </p>
                    <p className="text-sm text-slate-grey leading-relaxed">
